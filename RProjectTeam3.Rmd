...
The dataset is that this report is based on is called "Teen Relationship Survey Pretest", obtained from the URL:http://www.pewinternet.org/datasets/sep-25-oct-9-2014-and-feb-10-march-6-2015-teens/
...
The dataset has 1642 entries (number of adult who completed the survey) and 317 variables (answers of each question). 
...
* rows where caseID is not a valid number is removed, by coverting caseID from factor to character to integer and eliminated the NA entries
...
* entries where the children are not 13-17 in age are removed
